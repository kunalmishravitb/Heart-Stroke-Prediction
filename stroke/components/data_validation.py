...
from stroke.utils.main_utils import read_yaml_file, write_yaml_file
from stroke.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact
from stroke.entity.config_entity import DataValidationConfig

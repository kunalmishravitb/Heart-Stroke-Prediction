import os, pickle, sys, boto3

from io import StringIO
from typing import List, Union
from pandas import DataFrame, read_csv
from botocore.exceptions import ClientError
from stroke.configuration.aws_connection from S3Client
...
class SimpleStorageService:
    ...
    # This is the function which we will be utilizing in model evaluation to take the production model
    def load_model(self, model_name: str, bucket_name: str, model_dir: str=None) -> object:
        """
        Method Name : load_model
        Description : This method loads the model_name model from bucket_name bucket with kwargs (keyword arguments)
    ...
    # This function is used to upload the local file to s3 bucket
    ...
    # It is a method which is used to take csv file from a local system and it will be converted into dataframe and that dataframe will be uploaded 
